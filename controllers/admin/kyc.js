...
export const approveDocument = async (req, res) => {
    try {
        ...
        // 6) The database trigger will automatically update kyc_verifications table
        // based on the document approval, so we don't need to manually update it here
...
export const rejectDocument = async (req, res) => {
    try {
        ...
        // 6) The database trigger will automatically update kyc_verifications table
        // based on the document rejection, so we don't need to manually update it here
